/****************************************************************************************
** Program Filename: Oscillator.cpp
** Author: Chris Kearns
** Date: 1/17/2016
** Description: Contains the oscillator() function.
...
void oscillator(int anArray[]) {
	...
	// "Inject" initial Galaxy image. See fotnote (6) in Main.cpp
	int i, j;
	i = j = 0;

	matrix_0[i - 4 + yOffset][j - 2 + xOffset] = "X";
	matrix_0[i - 4 + yOffset][j + 1 + xOffset] = "X";
	matrix_0[i - 4 + yOffset][j + 3 + xOffset] = "X";
	matrix_0[i - 3 + yOffset][j - 4 + xOffset] = "X";
	matrix_0[i - 3 + yOffset][j - 3 + xOffset] = "X";
	matrix_0[i - 3 + yOffset][j - 1 + xOffset] = "X";
	matrix_0[i - 3 + yOffset][j + 1 + xOffset] = "X";
	matrix_0[i - 3 + yOffset][j + 2 + xOffset] = "X";
	matrix_0[i - 3 + yOffset][j + 3 + xOffset] = "X";
	matrix_0[i - 2 + yOffset][j - 3 + xOffset] = "X";
	matrix_0[i - 2 + yOffset][j + 4 + xOffset] = "X";
	matrix_0[i - 1 + yOffset][j - 4 + xOffset] = "X";
	matrix_0[i - 1 + yOffset][j - 3 + xOffset] = "X";
	matrix_0[i - 1 + yOffset][j + 3 + xOffset] = "X";
	matrix_0[i + 1 + yOffset][j - 3 + xOffset] = "X";
	matrix_0[i + 1 + yOffset][j + 3 + xOffset] = "X";
	matrix_0[i + 1 + yOffset][j + 4 + xOffset] = "X";
	...
	for (int i = 0; i < iterations; i++) {
		...
		cout << "\033[41A" << "Jan Kok's Galaxy is running from point: (" << anArray[2]
