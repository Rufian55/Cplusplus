/****************************************************************************************
** Program Filename: Stable.cpp
** Author: Chris Kearns (CS-162-400 W2016)
** Date: 1/17/2016
** Description: Contains the stable() function.
** Input: array "collector"
** Output: Used by Main.cpp to generate a Stable Box animation.
*****************************************************************************************/
#include "Stable.hpp"
#include <iomanip>
using std::setw;
...
/***************************************************************************************
** Function: stable()
** Description: Description: animation function that generates Stable Box images.
...
void stable(int anArray[]) {
	...
	int xOffset = anArray[2] + 8;					// x axis offset for initial image.
	int yOffset = anArray[3] + 8;					// y-axis offset for inital image.
	...
	// "Inject" initial Stable image. See footnote (8) at Main.cpp	
	int i, j;
	i = j = 0;
	...
	matrix_0[i + 1 + yOffset][j + 1 + xOffset] = "X";
	...
	for (int i = 0; i < iterations; i++) {
		...
		cout << "\033[41A" << "Stable Image is running from point: (" << anArray[2]
