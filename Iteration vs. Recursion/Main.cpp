...
*************************************************************************/
	...
	/* Calculate time taken by a Recursive Function Call (1) */
	clock_gettime(CLOCK_REALTIME, &requestStart);
	fr.PrintFibonacci(); // "Recursive"
	clock_gettime(CLOCK_REALTIME, &requestEnd);

	/* Display time taken by a Recursive Function Call (1) */
...
*************************************************************************/
	...
	/* Calculate time taken by a Non Tail Recursive Factorial Function Call (1) */
	...
	/* Calculate time taken by a Tail Recursive Factorial Function Call (1) */
	clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &requestStart);
...
/*
Citations:
(1)	h ttp://stackoverflow.com/questions/2418157/ubuntu-linux-c-error-undefined-reference-to-clock-gettime-and-clock-settim
(2) Also see included header files for additional citations. 
*/