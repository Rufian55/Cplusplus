...
** Output: Used by Main.cpp to generate Glider animation.
*****************************************************************************************/
#include "Glider.hpp"
#include <iomanip>
using std::setw;
...
/***************************************************************************************
** Function: glider()
** Description: Description: animation function that generates Glider images.
...
void glider(int anArray[]) {
	...
	// "Inject" initial image. See footnote(5) in Main.cpp
	int i, j;
	i = j = 0;
	...
	for (int i = 0; i < iterations; i++) {
		...
		cout << "\033[41A" << "Glider is running from point: (" << anArray[2]
