...
int BlueMen::roll(string aORd) {
	...
	cout << "BlueMen rolled " << result << endl;
...
void BlueMen::defend(int aR) {
	...
	cout << "BlueMen defending with " << bmDie << " die." << endl;
	...
	if (checkPulse()) {
		cout << "BlueMen: Your attack has failed, we will crawl inside your dead body!" << endl;
	}
	else {
		cout << "BlueMen: We've died a good death!" << endl;
	}
}
